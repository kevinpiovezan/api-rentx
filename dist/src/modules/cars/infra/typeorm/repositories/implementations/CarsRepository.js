...
var CarsRepository = /** @class */ (function () {
    ...
    CarsRepository.prototype.findById = function (car_id) {
        return __awaiter(this, void 0, void 0, function () {
            var car;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.findOne(car_id)];
                    case 1:
                        car = _a.sent();
                        return [2 /*return*/, car];
                }
    ...
    CarsRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var car;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CarsRepository.prototype.findByLicensePlate = function (license_plate) {
        var car = this.repository.findOne({ license_plate: license_plate });
        return car;
    };
    CarsRepository.prototype.list = function (name, brand, category_id) {
        return __awaiter(this, void 0, void 0, function () {
            var carsQuery, cars;
            return __generator(this, function (_a) {
                switch (_a.label) {
