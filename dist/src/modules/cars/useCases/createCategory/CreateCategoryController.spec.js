...
describe('Create Category Controller', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    password = _a.sent();
                    id = (0, uuid_1.v4)();
                    return [4 /*yield*/, connection.query("INSERT INTO USERS(id, name, email, password, \"isAdmin\", created_at, driver_license) values ('" + id + "', 'admin', 'admin1@rentx.com', '" + password + "', true, 'now()', 'XXXXXX')")];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to create a new category if one with the same name already exists', function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseToken, refresh_token, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.app).post('/sessions').send({
