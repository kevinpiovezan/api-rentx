        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    password = _a.sent();
                    id = (0, uuid_1.v4)();
                    return [4 /*yield*/, connection.query("INSERT INTO USERS(id, name, email, password, \"isAdmin\", created_at, driver_license) values ('" + id + "', 'admin', 'admin@rentx.com', '" + password + "', true, 'now()', 'XXXXXX')")];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
