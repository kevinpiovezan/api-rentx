...
var CreateSpecificationController = /** @class */ (function () {
    ...
    CreateSpecificationController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, createSpecificationsUseCase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, description = _a.description;
                        createSpecificationsUseCase = tsyringe_1.container.resolve(CreateSpecificationUseCase_1.CreateSpecificationsUseCase);
                        return [4 /*yield*/, createSpecificationsUseCase.execute({ name: name, description: description })];
                    case 1:
                        _b.sent();
