...
var CreateRentalUseCase = /** @class */ (function () {
    ...
    CreateRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var carUnavailable, rentalOpenToUser, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.rentalsRepository.findByCar(car_id)];
                    case 1:
                    ...
                    case 2:
                        ...
                        if (rentalOpenToUser) {
                            throw new AppError_1.AppError('User already have an open rental');
                        }
                        compare = this.dateProvider.compareInHours(this.dateProvider.dateNow(), expected_return_date);
                        if (compare < 24) {
