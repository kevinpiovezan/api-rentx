...
describe('Create Rental', function () {
    ...
    beforeEach(function () {
        ...
        createRentalUseCase = new CreateRentalUseCase_1.CreateRentalUseCase(rentalsRepositoryInMemory, dateProvider, carsRepositoryInMemory);
    });
    ...
    it('should not be able to create a new rental if the car already has one rental opened', function () { return __awaiter(void 0, void 0, void 0, function () {
        var car;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carsRepositoryInMemory.create({
    ...
    it('should not be able to create a new rental if the user already has one opened', function () { return __awaiter(void 0, void 0, void 0, function () {
        var car;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carsRepositoryInMemory.create({
                ...
                case 2:
                    ...
                    expect(createRentalUseCase.execute({
                        ...
                        car_id: car.id,
                        expected_return_date: dayAdd24Hours,
                    })).rejects.toEqual(new AppError_1.AppError('User already have an open rental'));
                    return [2 /*return*/];
            }
        });
    }); });
    it('should not be able to create a new rental if the expected return is lower than 24h', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
