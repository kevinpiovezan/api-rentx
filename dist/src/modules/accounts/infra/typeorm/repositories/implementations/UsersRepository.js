...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var name, driver_license, email, password, id, avatar, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = data.name, driver_license = data.driver_license, email = data.email, password = data.password, id = data.id, avatar = data.avatar;
