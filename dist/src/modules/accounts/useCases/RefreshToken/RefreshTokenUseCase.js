...
var RefreshTokenUseCase = /** @class */ (function () {
    ...
    RefreshTokenUseCase.prototype.execute = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sub, email, user_id, userToken, expires_date, refresh_token, newToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = (0, jsonwebtoken_1.verify)(token, auth_1.default.secret_refresh_token), sub = _a.sub, email = _a.email;
                        user_id = sub;
                        return [4 /*yield*/, this.usersTokensRepository.findByIdAndRefreshToken(user_id, token)];
                    case 1:
                        userToken = _b.sent();
                        if (!userToken) {
                            throw new AppError_1.AppError('User token not found!');
                        }
                        return [4 /*yield*/, this.usersTokensRepository.deleteById(userToken.id)];
                    case 2:
                        _b.sent();
                        expires_date = this.dateProvider.addDays(auth_1.default.expires_in_refresh_token_days);
    ...
    RefreshTokenUseCase = __decorate([
        ...
        __param(1, (0, tsyringe_1.inject)('DateProvider')),
