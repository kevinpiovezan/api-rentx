...
var SendForgotPasswordEmailUseCase = /** @class */ (function () {
    function SendForgotPasswordEmailUseCase(usersRepository, usersTokensRepository, dateProvider, mailProvider) {
        this.usersRepository = usersRepository;
        this.usersTokensRepository = usersTokensRepository;
        this.dateProvider = dateProvider;
        this.mailProvider = mailProvider;
    }
    SendForgotPasswordEmailUseCase.prototype.execute = function (email) {
    ...
    SendForgotPasswordEmailUseCase = __decorate([
    ...
    return SendForgotPasswordEmailUseCase;
}());
