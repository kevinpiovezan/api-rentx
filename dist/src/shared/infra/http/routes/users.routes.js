...
var createUserControler = new CreateUserController_1.CreateUserController();
var updateUserAvatarController = new UpdateUserAvatarController_1.UpdateUserAvatarController();
var profileUserContoller = new ProfileUserController_1.ProfileUserController();
...
usersRoutes.get('/profile', ensureAuthenticated_1.ensureAuthenticated, profileUserContoller.handle);
