...
const createUserControler = new _CreateUserController.CreateUserController();
const updateUserAvatarController = new _UpdateUserAvatarController.UpdateUserAvatarController();
const profileUserContoller = new _ProfileUserController.ProfileUserController();
...
usersRoutes.get('/profile', _ensureAuthenticated.ensureAuthenticated, profileUserContoller.handle);